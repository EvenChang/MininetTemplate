...
if __name__ == '__main__':
    ...
    #
    h1 = net.addHost('h1', mac="00:00:00:00:00:a1", ip='40.100.1.1/24')
#    h1 = net.addHost('h1', mac="00:00:00:00:00:a1", ip='192.168.1.1/24')
    h2 = net.addHost('h2', mac="00:00:00:00:00:a2", ip='40.100.2.1/24')
...
#    h6 = net.addHost('h6', cls=VLANHost, vlan=200, mac="00:00:00:00:00:a6", ip='192.168.6.1/24')
 #   h6 = net.addHost('h6', mac="00:00:00:00:00:a6", ip='192.168.1.6/24')
    ...
    net.addLink(h2, s3, port1=1, port2=1)
    ...
    #       "h1-eth1.100")
    h1.cmd("route add -net 0.0.0.0 gw 40.100.1.100 " +
           "h1-eth1")
    h2.cmd("route add -net 0.0.0.0 gw 40.100.2.100 " +
           "h2-eth1")
